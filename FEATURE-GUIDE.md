...
**What it’s for:** Reviewing and resolving abuse reports from peer skill-share sessions and the skill-share Board — analyst-to-analyst conduct only. This is where the Team Lead opens a sealed case, reads the flagged content, and closes it with a verdict.
