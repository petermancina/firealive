...
check('MC approval_method CHECK is passkey-only', /second-person-passkey/.test(mcInit) && !/'second-person-totp'/.test(mcInit));
check('GD approval_method CHECK is passkey-only', /second-person-passkey/.test(gdInit) && !/'second-person-totp'/.test(gdInit));
