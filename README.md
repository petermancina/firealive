...
**Version:** v1.0.35 | **License:** AGPL-3.0-or-later | **Author:** Peter Mancina   
**E-fuse counter:** 28 (anti-rollback)
...
**Download installers:** Pre-built installers for Mac (.dmg), Windows (.exe), and Linux (.AppImage) are available on the [Releases page](https://github.com/petermancina/firealive/releases/tag/v1.0.35) under Tags.
