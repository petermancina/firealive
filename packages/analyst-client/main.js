...
// Legacy alias (verify-only): the renderer's old "download" action now verifies
// the operator-provisioned files. Removed once preload (C8) and the renderer
// (C9) move to kbChat:verifyModel. FireAlive performs no downloads.
