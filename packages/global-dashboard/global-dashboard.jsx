...
export default function GlobalDashboard() {
  ...
  const navItems=[
    ...
    {id:"backup",label:"Backup & Restore"},{id:"restore",label:"Restore"},{id:"backup_schedules",label:"Backup Schedules"},{id:"migration",label:"Deployment Migration"},{id:"data_sov",label:"Data Sovereignty"},{id:"recert",label:"Recertification"},
