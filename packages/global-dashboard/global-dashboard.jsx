...
export default function GlobalDashboard() {
  ...
  // Load the live data-residency posture when the Data Sovereignty tab is active:
  // the declared policy, per-destination compliance, the console fleet's residency,
  // and the cross-border transfer register.
  useEffect(() => {
