      ...
      <div style={{display:"flex",minHeight:"calc(100vh - 80px)"}}>
        ...
        <div style={{flex:1,padding:24,overflowY:"auto",animation:"fadeIn 0.3s ease"}}>
          ...
          {tab==="compliance_posture"&&(<div>
            ...
            {postureReport&&!postureLoading&&<Card>
              <M style={{color:C.td,fontStyle:"italic"}}>Report received. Rendering UI coming in PR4 commits 3-4 (summary + verifiedControls + customerResponsibility).</M>
            </Card>}
          </div>)}

          {/* ══════════ CROSS-REGION COMPLIANCE (PR4 C1 scaffold) ══════════ */}
          {tab==="compliance_xregion"&&(<div>
            ...
            <Card>
              <M style={{color:C.td,fontStyle:"italic"}}>Coming in PR4 commits 5-10: rollup matrix + filter controls + drilldown + mailbox-pattern Request Full Report flow.</M>
            </Card>
          </div>)}
