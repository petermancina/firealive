          ...
          {tab==="connections"&&(<div>
            ...
            <Card style={{marginBottom:12,borderColor:(pendingKeys&&pendingKeys.length>0)?C.w+"40":C.b}}>
              ...
              {pendingKeys&&!pendingKeysLoading&&pendingKeys.length>0&&<div>
                ...
                <M style={{color:C.td,display:"block",marginTop:8,fontSize:9,fontStyle:"italic"}}>Reject action with reason capture lands in PR4 commit 14.</M>
              </div>}
            </Card>
            ...
            {mcs.map(mc=>{
              ...
              return <Card key={mc.id} style={{marginBottom:8,borderColor:keysOpen?C.a+"40":C.b}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                  ...
                  <div style={{display:"flex",gap:8,alignItems:"center"}}>
                    ...
                    <Btn small onClick={()=>setExpandedMcKeysFor(keysOpen?null:mc.id)}>{keysOpen?"Hide keys":"Keys"}</Btn>
