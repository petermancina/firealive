      ...
      <div style={{marginTop:8,borderTop:`1px solid ${C.b}`,paddingTop:16}}>
        ...
        {exportReq && (
          <div>
            ...
            {exportReq.status==="approved" && <div style={{fontSize:12,color:C.a,lineHeight:1.6,marginBottom:6}}>Approved. The case file can be produced from this device (next step).</div>}
