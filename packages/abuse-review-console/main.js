...
let generateReviewerKeypair, openAsReviewer, wrapPrivateKey, fingerprintForPubB64;
try {
  ({ generateReviewerKeypair, openAsReviewer, wrapPrivateKey, fingerprintForPubB64 } = require('./abuse-seal'));
} catch {
  ({ generateReviewerKeypair, openAsReviewer, wrapPrivateKey, fingerprintForPubB64 } = require('../shared/abuse-seal'));
}
