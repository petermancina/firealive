...
// private key. Handles both the multi-recipient format (FAS2, current) and the
// legacy single-recipient format (FAS1, pre-PR-I flags) via the magic-dispatching
// openForReviewer. Refuses when the key is locked. Decryption happens only here;
// the renderer receives plaintext to display. The private key is never returned.
