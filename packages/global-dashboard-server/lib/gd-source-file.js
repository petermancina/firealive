...
// ═══════════════════════════════════════════════════════════════════════════
// gd-source-file.js  --  the one sanctioned way to join __dirname with a variable
// ═══════════════════════════════════════════════════════════════════════════
//
...
//      packages/global-dashboard-server/lib/gd-data-root.js, and the 18th gate
...
//      the GD HA self-scans in index.js iterate a hardcoded list of .js files and read
