...
const externalSvc = require('../services/gd-external-restore');
...
function sendError(res, err) {
  ...
  console.error('external-restore unexpected error', {
...
router.post('/restore-execute/:approvalId', gdMfaStepUp(), async (req, res) => {
  let db;
  try {
