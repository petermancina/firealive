// ═══════════════════════════════════════════════════════════════════════════════
// FIREALIVE -- Export Encryption At-Rest Migration (boot-time, idempotent) -- Global Dashboard variant
//
...
// at-rest posture (at_rest_scheme, at_rest_kek_ref) on the row. On the GD the
// scheme is gd-tier1 (the wrap goes through the GD export-encryption module,
// which seals under the GD's own derived Tier-1 KEK via gd-encryption).
//
...
//
// Invoked once at GD-server startup (see packages/global-dashboard-server/index.js). Because it runs before
