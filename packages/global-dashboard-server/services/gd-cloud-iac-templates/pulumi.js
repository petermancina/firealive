...
function renderAws(snapshot) {
  const idx = [
    ...
    'const imageRef = cfg.get("firealiveImage") ?? "ghcr.io/petermancina/firealive-gd:latest";',
    ...
    '  - docker run -d --name firealive-gd --restart=always -p 4001:4001 --env-file /etc/firealive-gd/.env -v firealive-gd-data:/data ${imageRef}`;',
    '',
