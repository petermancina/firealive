// ===============================================================================
// FIREALIVE GD -- Cloud & IaC Templates: GCP Deployment Manager (B6c PR-5 twin)
//
...
function render(snapshot, provider) {
  ...
  const main = [
    ...
    '    properties:',
    '      secretId: firealive-gd-encryption-key',
    '      replication: { automatic: {} }',
    '',
    '  - name: firealive-gd-encryption-key-version',
    '    type: gcp-types/secretmanager-v1:projects.secrets.versions',
    '    properties:',
    '      parent: $(ref.firealive-gd-encryption-key.name)',
    '      payload:',
    '        data: $(ref.firealive-gd-encryption-key-data)',
    '',
    '  - name: firealive-gd-jwt-secret',
    '    type: gcp-types/secretmanager-v1:projects.secrets',
    '    properties:',
    '      secretId: firealive-gd-jwt-secret',
    '      replication: { automatic: {} }',
    '',
    '  - name: firealive-gd-jwt-secret-version',
    '    type: gcp-types/secretmanager-v1:projects.secrets.versions',
    '    properties:',
    '      parent: $(ref.firealive-gd-jwt-secret.name)',
    '      payload:',
    '        data: $(ref.firealive-gd-jwt-secret-data)',
    '',
    ...
    '              TIER1=`gcloud secrets versions access latest --secret=firealive-gd-encryption-key`',
    '              JWT=`gcloud secrets versions access latest --secret=firealive-gd-jwt-secret`',
    '              umask 077',
    ...
    'outputs:',
    '  - name: instanceIp',
    '    value: $(ref.firealive-gd.networkInterfaces[0].accessConfigs[0].natIP)',
    '',
