// ═══════════════════════════════════════════════════════════════════════════════
// FIREALIVE GLOBAL DASHBOARD — Built-in Certificate Authority (Phase B5b)
//
...
//
// THIS IS THE GLOBAL DASHBOARD'S CA INSTANCE
//   The Global Dashboard is a separate trust realm and runs its own CA, distinct
//   from the management console's. This module IS that instance: it uses the GD's
//   own encryption (gd-encryption) and the GD's own ca_authority / issued_certs
//   tables. A GD-issued cert is not trusted by an MC and vice-versa, by design.
// ═══════════════════════════════════════════════════════════════════════════════
