// ═══════════════════════════════════════════════════════════════════════════════
// FIREALIVE GLOBAL DASHBOARD — FIDO2 Attestation Trust-Anchor Seed Loader (B5n3)
// ═══════════════════════════════════════════════════════════════════════════════
//
// Purpose
//   Reads packages/global-dashboard-server/data/fido-attestation-roots.json (the
//   bundled, provenance-pinned seed of trusted FIDO-certified vendor attestation
//   root CAs) and populates the GD's fido_trusted_roots table. It is the GD twin
//   of server/db/seed-fido-roots.js. A hardware passkey is accepted at login
//   enrollment only if its attestation chains to one of these roots (or to a root
//   an admin adds later through the IAM admin surface), so this seed is the trust
//   floor for the hardware-credential login gate.
//
// Idempotency
...
//   attestation-chain check happens at enrollment in gd-webauthn.js; this is a
