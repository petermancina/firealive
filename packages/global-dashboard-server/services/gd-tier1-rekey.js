...
// FIREALIVE (Global Dashboard) -- Offline node rekey (B6h B-4)
//
// GD twin of server/services/tier1-rekey.js: same rekeyNode over the GD Tier-1 chokepoint
// and the 4 GD replicated columns.
//
...
const REPLICATED = GD_TIER1_COLUMNS.filter((c) => c.domain === 'replicated');
