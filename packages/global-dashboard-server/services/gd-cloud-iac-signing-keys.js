// ===============================================================================
// FIREALIVE GD -- Cloud & IaC Signing Keys Lifecycle Service (B6c PR-5 twin)
//
...
// archives via gd-cosign-signer.signBlob.
//
// PARALLEL TO gd-backup-signing-keys, NOT MULTIPLEXED
// ================================================
//
...
// of gd-backup-signing-keys but operates against its own table.
//
// ALGORITHM
// =========
//
...
// decryptConfig from gd-encryption.js, AES-256-GCM via the KMS-
// or env-var-supplied KEK). The unwrap step happens just-in-time
// during signing; PEM bytes never persist on disk outside the gd-cosign-
...
const logger = {
  ...
  error: (m, o) => console.error('[gd-cloud-iac-signing-keys] ' + m, o || ''),
};
