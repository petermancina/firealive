// ═══════════════════════════════════════════════════════════════════════════
// FIREALIVE — Global Dashboard pidfile  (B6k)
...
// WHY THIS EXISTS
//
// the shared restore-swap primitive atomically renames restored bytes over the live
...
//
// NOT TO BE CONFUSED WITH gd-ha-liveness.js
//
// gd-ha-liveness.js carries HA failover signals -- in-process timestamps the
// active node's self-fence consumes to decide whether it still sees traffic.
// This module answers an unrelated question: is a server PROCESS alive that
// owns this data root. They share no state and no purpose. This one is named
// for what it physically is, a pidfile, so the two cannot be conflated.
//
