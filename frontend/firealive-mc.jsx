...
function ManagementConsole() {
  ...
  useEffect(()=>{
    ...
    api.get("/api/gd-config").then(r=>{
      if (r && !r.error) {
        setGlobalDashCfg(prev=>({...prev, ...r, api_key_input:"", _loaded:true}));
      }
    }).catch(()=>{});
