...
// (Node crypto only), so a plain require is enough. The flagger side uses
// sealToReviewers; the Team-Lead review side uses the keypair/open/wrap helpers
// (the lead holds the private key and opens sealed cases in this main process).
let sealToReviewers, generateReviewerKeypair, openForReviewer, wrapPrivateKey,
  unwrapPrivateKey, fingerprintForPubB64, publicKeyB64FromPrivate;
try {
  ({ sealToReviewers, generateReviewerKeypair, openForReviewer, wrapPrivateKey,
