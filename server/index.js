...
app.use('/api/threat-hunting', authMiddleware(['admin']), configLockChokepoint(), require('./routes/threat-hunting-admin'));
app.use('/api/threat-hunting-feed', threatHuntingGate, require('./routes/threat-hunting-feed'));
app.use('/taxii2', threatHuntingGate, require('./routes/threat-hunting-taxii'));
