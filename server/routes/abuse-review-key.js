...
// An X25519 SPKI-DER public key is 44 bytes (~60 base64 chars); cap generously
// without inviting abuse. Mirrors the e2ee-keys.js base64 validation.
...
router.post('/', (req, res) => {
  ...
  const algoVal = (typeof algo === 'string' && algo.length > 0 && algo.length <= 64) ? algo : 'x25519-hkdf-sha256-aes256gcm';
