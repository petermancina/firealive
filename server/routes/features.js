...
const FEATURE_CATALOG = [
  ...
  { id: 'lead_messaging', name: 'Anonymous Lead Messaging', category: 'wellbeing', klass: 'toggle', default: true,
    desc: 'Encrypted anonymous messages from analysts to their lead.' },
  { id: 'lead_chat_identified', name: 'Identified Lead Chat', category: 'wellbeing', klass: 'toggle', default: true,
    desc: 'Identified (non-anonymous) analyst-to-lead chat channel.' },
  ...
  { id: 'legal_hold', name: 'Legal Hold', category: 'management', klass: 'locked', default: true,
    reason: 'Compliance and forensic preservation; cannot be disabled.' },
