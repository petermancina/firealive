...
accessRouter.post('/', (req, res) => {
  ...
  try {
    ...
    // Narrowed to rows BOUND to this certificate. A row with a NULL
      // cert_fingerprint -- every row on a database upgraded across O3 --
      // cannot match, because SQL equality never matches NULL.
