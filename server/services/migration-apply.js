...
const reconcileSvc = require('./migration-reconcile');
const migrationIdentity = require('./migration-identity');
const dbRestoreSwap = require('./db-restore-swap');
const goldenBaseline = require('./golden-baseline');
...
async function applyReconciliation(db, options) {
  ...
  logger.info('migration-apply: reconciliation applied', {
