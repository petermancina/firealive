// FIREALIVE -- Confidential-computing attestation orchestrator (Cloud Mode)
//
// Cloud Mode requires the regional server to run inside a confidential VM whose
...
const sevSnp = require('./attestation-sev-snp');
