// FIREALIVE -- Guest-side CPU side-channel mitigation gate (B5l2 Cloud Mode, co-tenancy)
//
// In Cloud Mode, FireAlive's confidential VM shares physical CPU hardware with
