...
// FIREALIVE -- offline node rekey CLI (B6h B-4)
//
...
//
//   Usage:  node rekey-node.js --koa <koa-id>
...
const { rekeyNode } = require('../services/tier1-rekey');
...
function main(argv) {
  ...
  if (!args.koaId) {
    process.stderr.write('usage: node rekey-node.js --koa <koa-id>\n');
    return 2;
  }
