...
// FIREALIVE -- offline import rekey CLI (B6h B-6, FA-MIG1)
//
...
//
//   Usage:  node import-rekey.js --bundle-dir <dir> --koa <koa-id> \
...
const dbRestoreSwap = require('../services/db-restore-swap');
const { importRekey } = require('../services/tier1-import-rekey');
...
async function main(argv) {
  ...
  if (!args.bundleDir || !args.koaId || !args.recoveryCode || !args.passphrase) {
    process.stderr.write('usage: node import-rekey.js --bundle-dir <dir> --koa <koa-id> --recovery-code <code> --passphrase <passphrase>\n');
    return 2;
  }
