...
function initDb() {
  ...
  try {
    ...
    try {
      ...
      db.exec('CREATE INDEX IF NOT EXISTS idx_vuln_scan_auth_cert_fp ON vuln_scan_scanner_authorizations(cert_fingerprint)');
      db.exec('CREATE INDEX IF NOT EXISTS idx_cloud_vuln_auth_cert_fp ON cloud_vuln_scanner_authorizations(cert_fingerprint)');
    } catch (e) {
